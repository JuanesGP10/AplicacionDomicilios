...
{
    [TestClass]
    public sealed class RastreoRepartidorUCom
    {
        private readonly string urlBase = "https://localhost:7065/RastreoRepartidor";

        [TestMethod]
        public async Task Verificar_RastreoRepartidor_GET()
        {
            ...
            throw new Exception("El método GET para RastreoRepartidor no retornó la estructura esperada.");
        }

        [TestMethod]
        public async Task Ciclo_POST_PUT_DELETE_RastreoRepartidor()
        {
            Comunicaciones comunicaciones = new Comunicaciones();
            ...
            {
                { "Url", $"{urlBase}/guardar" },
                { "Entidad", new { Id = 0, RepartidorId = 6, Latitud = 6.2442m, Longitud = -75.5812m, FechaActualizacion = DateTime.Now } }
            };
            ...
            var objetoCreado = JsonConvert.DeserializeObject<RastreoRepartidor>(jsonObjetoCreado);
            ...
            var datosPut = new Dictionary<string, object>
            {
                ...
                { "Entidad", new { Id = IdGenerado, RepartidorId = 6, Latitud = 6.2518m, Longitud = -75.5636m, FechaActualizacion = DateTime.Now } }
            };
