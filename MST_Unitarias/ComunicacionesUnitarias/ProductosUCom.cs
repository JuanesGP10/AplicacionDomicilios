...
{
    [TestClass]
    public sealed class ProductosUCom
    {
        private readonly string urlBase = "https://localhost:7065/Productos";

        [TestMethod]
        public async Task Verificar_Productos_GET()
        {
            ...
            throw new Exception("El método GET para Productos no retornó la estructura esperada.");
        }

        [TestMethod]
        public async Task Ciclo_POST_PUT_DELETE_Productos()
        {
            Comunicaciones comunicaciones = new Comunicaciones();
            ...
            {
                { "Url", $"{urlBase}/guardar" },
                { "Entidad", new { Id = 0, CategoriaId = 1, Nombre = "Producto Prueba", Descripcion = "Descripción de prueba", Precio = 12000.00m, Stock = 50, Urlimagen = "https://link-imagen.com/test.jpg", Activo = true } }
            };
            ...
            var objetoCreado = JsonConvert.DeserializeObject<Productos>(jsonObjetoCreado);
            ...
            var datosPut = new Dictionary<string, object>
            {
                ...
                { "Entidad", new { Id = IdGenerado, CategoriaId = 1, Nombre = "Producto Modificado", Descripcion = "Descripción modificada", Precio = 14500.00m, Stock = 45, Urlimagen = "https://link-imagen.com/test-modificado.jpg", Activo = true } }
            };
