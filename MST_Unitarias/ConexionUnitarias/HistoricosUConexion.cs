...
{
    [TestClass]
    public sealed class HistoricosUConexion
    {
        [TestMethod]
        public void VerificarConexionBaseDatos_Historicos()
        {
            ...
            var lista = conexion.Historicos!.ToList();

            if (lista.Count > 0)
                return;

            throw new Exception("Error: La tabla de Históricos en la base de datos está vacía o no se pudo establecer conexión.");
        }
    }
}