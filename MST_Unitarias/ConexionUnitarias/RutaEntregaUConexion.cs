...
{
    [TestClass]
    public sealed class RutaEntregaUConexion
    {
        [TestMethod]
        public void VerificarConexionBaseDatos_RutaEntrega()
        {
            ...
            var lista = conexion.RutaEntrega!.ToList();

            if (lista.Count > 0)
                return;

            throw new Exception("Error: La tabla de RutaEntrega en la base de datos está vacía o no se pudo establecer conexión.");
        }
    }
}
