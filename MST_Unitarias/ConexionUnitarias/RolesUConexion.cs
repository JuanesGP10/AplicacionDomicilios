...
{
    [TestClass]
    public sealed class RolesUConexion
    {
        [TestMethod]
        public void VerificarConexionBaseDatos_Roles()
        {
            ...
            throw new Exception("Error: La tabla de Roles en la base de datos está vacía o no se pudo establecer conexión.");
        }
    }
}
