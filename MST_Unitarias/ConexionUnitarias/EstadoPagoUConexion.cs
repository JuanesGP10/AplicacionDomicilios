...
{
    [TestClass]
    public sealed class EstadoPagoUConexion
    {
        [TestMethod]
        public void VerificarConexionBaseDatos_EstadoPago()
        {
            ...
            var lista = conexion.EstadoPago!.ToList();

            if (lista.Count > 0)
                return;

            throw new Exception("Error: La tabla de EstadoPago en la base de datos está vacía o no se pudo establecer conexión.");
        }
    }
}
